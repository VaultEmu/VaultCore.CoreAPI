...
/// <summary>
/// Simple interface for a logging feature. Should be provided by all frontends for basic core logging at different levels
/// </summary>
public interface ILogging :  IVaultCoreFeature
{
    /// <summary>
